...
import { CAN_PLAY, REFRESH, REFRESH_COMPLETE, WAITING } from '../refresh/refresh-event';
import { AbstractAnimation } from '../animation/abstract-animation';
import { AniController } from '../animation/ani-controller';
import { frame } from '../animation/frame';
import { EncodeOptions } from '../codec/define';
import { getEncoder } from '../codec';
...
import dualDownFrag from '../gl/dual-down.frag';
import dualUpFrag from '../gl/dual-up.frag';
...
import maskGrayFrag from '../gl/mask-gray.frag';
import bloomFrag from '../gl/bloom.frag';
import bloomBlurFrag from '../gl/bloom-blur.frag';
import dualDown13Frag from '../gl/dual-down13.frag';
import dualUp13Frag from '../gl/dual-up13.frag';
import lightDarkFrag from '../gl/light-dark.frag';
import dropShadowFrag from '../gl/drop-shadow.frag';
...
export class Root extends Container {
  ...
  async appendTo(canvas: HTMLCanvasElement) {
    ...
    // gl的初始化和配置
    const attributes = Object.assign({}, config.webglContextAttribute, this.props.contextAttributes);
