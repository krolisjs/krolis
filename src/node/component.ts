import { AbstractNode, ClientRect, NodeType, OffsetRect } from './abstract-node';
...
import { AbstractAnimation, Options } from '../animation/abstract-animation';
...
export class Component<T extends ComponentProps = ComponentProps> extends AbstractNode {
