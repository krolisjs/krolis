...
import { LOAD, META } from '../refresh/refresh-event';
import { ceilBbox } from '../math/bbox';

export interface ILottie extends Node {
  get src(): string | null;
  get currentTime(): number;
  set currentTime(v: number);
  get duration(): number;
  get metaData(): LottieMeta | null;
  get lottie(): NonNullable<any> | null;
}

export type LottieConstructor = new (props: LottieProps) => ILottie;

export class Lottie extends Node implements ILottie {
  private _src: string | null = null;
  private _json: NonNullable<any> | null = null;
  private _lottie: NonNullable<any> | null = null;
  private canvas: HTMLCanvasElement | OffscreenCanvas | null = null;
  onMeta: ((o: LottieMeta) => void) | null = null;
  onLoad: (() => void) | null = null;
  private _currentTime = 0;
  private _metaData: LottieMeta | null = null;
